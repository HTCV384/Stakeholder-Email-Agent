...
const fullPrompt = `You are writing an ultra-casual, insider-knowledge email to a healthcare stakeholder. The tone is peer-to-peer, not vendor-to-buyer.
...
await connection.execute(
  'UPDATE emailTemplates SET promptTemplate = ? WHERE id = 6',
  [fullPrompt]
);

console.log('✓ Updated template 6 with full Casual Insider Approach prompt');
